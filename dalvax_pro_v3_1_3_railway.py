...
class Config:
    ...
    def load_secrets(cls):
        ...
        env_secret = (
            env_str("OKX_SECRET_KEY") or env_str("OKX_SECRET") or env_str("SECRET_KEY")
        )
        env_pass = (
            env_str("OKX_PASSPHRASE") or env_str("PASSPHRASE")
        )
        ...
        print("❌ ERRO: Variáveis OKX_API_KEY, OKX_SECRET_KEY e OKX_PASSPHRASE não encontradas!")
        print("   Configure-as no painel do Railway → Variables")
...
logging.basicConfig(
    ...
    handlers=[logging.StreamHandler()],   # Railway captura stdout automaticamente
)
